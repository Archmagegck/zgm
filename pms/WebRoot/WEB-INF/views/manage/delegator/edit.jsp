  ...
  <body>
    <form id="myForm" name="myForm" action="${ctx}/manage/delegator/save" method="post">
    	<div id="content">
    		...
    		<h3 id="adddelegator">修改委托方</h3>
    		<br/>
    		<fieldset style="padding: 5px 10px;" id="personal">
    			<legend><h3>请输入相关信息</h3></legend>
    			<br/>
    				<input type="hidden" name="id" value = "${delegator.id }" >
					...
					<tr>
						...
						<td width="80%">
							<input id="code" name="code" value="${delegator.code }" class="required" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>
					<tr>
						<td width="20%">
						...
						<td width="80%">
							<input id="name" name="name" value="${delegator.name }" class="required" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>
					<tr>
						<td width="20%">
						...
						<td width="80%">
							<input id="username" name="username" value="${delegator.username }" class="required" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>
					<tr>
						<td width="20%">
						...
						<td width="80%">
							<input id="password" name="password" value="${delegator.password }" class="required" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>
					<tr>
						<td width="20%">
						...
						<td width="80%">
							<input id="address" name="address" value="${delegator.address }" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>
					<tr>
						<td width="20%">
						...
						<td width="80%">
							<input id="contact" name="contact" value="${delegator.contact }" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>
					<tr>
						<td width="20%">
						...
						<td width="80%">
							<input id="phone" name="phone" value="${delegator.phone }" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>
					<tr>
						<td width="20%">
