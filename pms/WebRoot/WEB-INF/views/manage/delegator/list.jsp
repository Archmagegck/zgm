...
<html>
	...
	<body>
		<form action="${ctx }/manage/delegator/list" method="post" id="myForm" name="myForm">
				...
				<div id="box">
					...
					<div align="left" style="vertical-align: middle;">
						...
						<select name="queryName" id="queryName">
							<option value="name" selected="selected">委托方名称</option>
							<option value="code">委托方编号</option>
						...
						<input type="button" value="添加" class="button" onclick="location.href='${ctx}/manage/delegator/add'" />
					...
					<table style="text-align: center; font: 12px/ 1.5 tahoma, arial, 宋体;" width="100%">
						...
						<c:forEach items="${page.content}" var="delegator">
							<tr>
								<td>
									<input type="checkbox" name="idGroup" value="${delegator.id }" />
								</td>
								<td>
									${delegator.code }&nbsp;
								</td>
								...
								<td>
									<a href="${ctx }/manage/delegator/edit/${delegator.id }">编辑</a>
								</td>
							</tr>
						</c:forEach>
					</table>
