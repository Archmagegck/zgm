    		...
    		<fieldset style="padding: 5px 10px;" id="personal">
    			...
    			<br/>
					...
					<tr>
						...
						<td width="80%">
							<input id="purity" name="purity" class="required" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;"/>
						</td>
					</tr>
					</table>
    			<br/>
