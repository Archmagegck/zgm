...
<html>
	<head>
		...
		function del(){
			if($("[name='idGroup']:checked").length <= 0){
				...
				if (confirm("确定要删除吗？")){
					$("#myForm").attr("action","${ctx}/manage/manager/delete");
					$("#myForm").submit();
				}
			}
		}
	...
	<body>
		<form action="${ctx }/manage/manager/list" method="post" id="myForm" name="myForm">
			<div align="center" id="content"">
				<div id="box">
					...
					<div align="left" style="vertical-align: middle;">
						...
						<input type="button" value="添加" class="button" onclick="location.href='${ctx}/manage/manager/add'" />
					...
					<table style="text-align: center; font: 12px/ 1.5 tahoma, arial, 宋体;" width="100%">
						...
						<c:forEach items="${page.content}" var="manager">
							<tr>
								<td>
									<input type="checkbox" name="idGroup" value="${manager.id }" />
								</td>
								<td>
									${manager.username }&nbsp;
								</td>
								...
								<td>
									<a href="${ctx }/manage/manager/edit/${manager.id }">编辑</a>
								</td>
							</tr>
						</c:forEach>
					</table>
