    		...
    		<fieldset style="padding: 5px 10px;" id="personal">
    			...
    			<br/>
					...
					<tr>
						...
						<td width="70%">
							<input id="style" name="style" class="required" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;"/>
						</td>
					</tr>
					<tr>
						<td width="30%">
						...
						<td width="70%">
							<select name="pledgePurity" class="required">
								<c:forEach items="${pledgePurityList}" var="pledgePurity">
									<option value = "${pledgePurity.purity }">${pledgePurity.purity }</option>
								</c:forEach>
							</select>
						</td>
					</tr>
