...
<html>
  ...
  <body>
    <form id="myForm" name="myForm" action="${ctx}/supervisor/pledgeRecord/uploadAttach" method="post" enctype="multipart/form-data">
    	<div id="content">
    		<div style="margin-bottom: 10px;padding: 5px 10px;" id="box">
    		<h3 id="adduser">上传质物清单扫描件</h3>
    		<br/>
    		<fieldset style="padding: 5px 10px;" id="personal">
    			<legend><h3>请选择文件上传</h3></legend>
    			<input type="hidden" name="pledgeRecordId" value = "${id}" >
    			<br/>
