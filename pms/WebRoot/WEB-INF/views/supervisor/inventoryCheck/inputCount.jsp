...
<html>
  ...
  <body>
    <form id="myForm" name="myForm" action="${ctx}/supervisor/inventoryCheck/general" method="post">
    	<div id="content">
    		<div style="margin-bottom: 10px;padding: 5px 10px;" id="box">
    		<h3 id="adduser">盘存检测登记</h3>
    		<br/>
    		<fieldset style="padding: 5px 10px;" id="personal">
    			...
    			<br/>
					...
					<tr>
						...
						<td width="70%">
							<input id="count" name="count" class="{required:true,number:true}" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;"/>
						</td>
					</tr>
					</table>
    			<br/>
