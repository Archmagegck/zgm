...
<html>
  ...
  <body>
    <form id="myForm" name="myForm" action="${ctx}/supervisor/personalInfo/save" method="post">
    	<div id="content">
    		<div style="margin-bottom: 10px;padding: 5px 10px;" id="box">
    		<h3 id="adddelegator">修改监管员个人信息</h3>
    		<br/>
    		<fieldset style="padding: 5px 10px;" id="personal">
    			...
    			<br/>
					...
					<tr>
						...
						<td width="80%">
							<input id="newpassword" name="newpassword" type="password" class="required" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>
					<tr>
						<td width="20%">
						...
						<td width="80%">
							<input id="confirm" name="confirm" class="required" type="password" equalTo="#newpassword" style="background: url('${ctx}/images/admin/images/form_blue.gif') repeat-x scroll left top #FFFFFF;border: 1px solid #D9E6F0;"/>
						</td>
					</tr>	
				</table>
    			<br/>
